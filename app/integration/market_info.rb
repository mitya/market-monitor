class MarketInfo
  ...
  # MoexIlliquid = %w[ENRU TGKDP FESH GCHE MRKP MSST BANE NMTP SELG MSNG ABRD KMAZ SVAV UWGN RENI UNAC POSI KAZT GRNT MRKC YAKG NKNC IRGZ LENT ROLO RSTIP LNZL LNZLP CNTLP CNTL KRKNP TGKB PMSB SFIN KAZTP LSNG MRKY TGKN MSRS BLNG GTRK KZOS NSVZ VRSB MGTSP PRFN DVEC MRKV TORS OKEY MRKZ KLSB IRKT TGKBP MSTT MRKS RBCM MRKU CHMK PMSBP RUGR KROT RKKE NKHP UNKL].to_set
  MoexIlliquid = %w[APTK CHMK CNTL CNTLP GEMC IRGZ IRKT KAZTP KLSB KRKNP KROT KZOS KZOSP LENT LIFE LNZL LNZLP LSNG MGTSP MRKU MRKV MRKY MRKZ MSNG MSRS MSST MSTT NKHP NSVZ OKEY ORUP PMSB PMSBP RBCM RENI RKKE ROLO RSTIP RTKMP SFIN SFTL SVAV TGKB TGKBP TGKDP TGKN TORS UNAC UNKL UWGN VEON-RX VRSB YAKG].to_set
