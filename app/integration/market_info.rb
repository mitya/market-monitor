class MarketInfo
  ...
  MoexIlliquid = %w[
    ...
    RKKE RNFT ROLO RSTI RSTIP RTKMP SFIN SFTL SVAV TATNP TGKA TGKB TGKBP TGKD TGKDP TGKN TORS TRMK TRNFP UNAC UNKL UPRO UWGN VEON-RX VRSB YAKG MDMG RUGR
  ].to_set

  MoexVeryIlliquid = %w[
    DVEC BLNG TGKD SFTL TORS MSTT TGKBP PMSB KROT SFIN PMSBP RKKE MGTSP MSST TGKN TGKDP YAKG RBCM SVAV KLSB VEON-RX TGKB NKHP IRKT KRKNP MRKY KZOS GEMC NSVZ GTRK CNTL
  ...
  MoexIgnored = %w[
    ...
    RSTIP IRGZ RENI CNTLP PRFN UNAC KAZTP LSNG APTK NKNC LNZL MSNG ROLO UNKL LENT DVEC BANE MRKP GRNT TGKD
  ].to_set
  ...
  OpeningTimes = { US: '09:00', Moex1: '10:00', Moex2: '10:00' }
  ClosingTimes = { US: '16:00', Moex1: '18:50', Moex2: '18:50' }
