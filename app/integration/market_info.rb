class MarketInfo
  ...
  MoexIlliquid = %w[ABRD APTK BANE BANEP BELU BLNG BSPB CHMK CIAN CNTL CNTLP DASB DVEC ENRU ETLN FEES FIXP FLOT GCHE GEMC GRNT GTRK IRGZ IRKT KAZT KAZTP KLSB KMAZ KRKNP KROT KZOS KZOSP
    ...
    RKKE RNFT ROLO RSTI RSTIP RTKMP SFIN SFTL SVAV TATNP TGKA TGKB TGKBP TGKD TGKDP TGKN TORS TRMK TRNFP UNAC UNKL UPRO UWGN VEON-RX VRSB YAKG MDMG].to_set

  MoexVeryIlliquid = %w[TORS MSTT TGKBP PMSB KROT SFIN PMSBP RKKE MGTSP MSST TGKN TGKDP YAKG RBCM SVAV KLSB VEON-RX TGKB NKHP IRKT KRKNP MRKY KZOS GEMC NSVZ GTRK CNTL
    RSTIP IRGZ RENI CNTLP PRFN UNAC KAZTP LSNG APTK NKNC LNZL MSNG ROLO UNKL CHMK LENT UWGN].to_set
